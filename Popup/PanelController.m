...
@synthesize fireworksAddressField = _fireworksAddressField;
...
- (void)awakeFromNib
{
    ...
    //load from settings
    [self.fireworksAddressField setStringValue:[[NSUserDefaults standardUserDefaults] stringForKey:@"fireworksAddress"]];
    [self.statusField setStringValue:@"awake from nib"];
}
...
- (IBAction)testAddress:(id)sender {
    ...
    [defaults setObject:[self.fireworksAddressField stringValue] forKey:@"fireworksAddress"];
